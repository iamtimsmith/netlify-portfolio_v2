...
![Install the Gatsby CLI tool](./code1.png)
...
![Default package.json file](./code3.png)
...
![Finished gatsby-config.js file](./code6.png)
...
![Gatsby-node.js file with blog posts being created](./code9.png)
...
![Our finished Blog Post Template](./code10.png)
